...
git clone \
    "https://github.com/HarishNagisetty/verilog3-mode.git" \
    ".emacs.d/elisp/verilog3-mode/"

git clone \
    "https://github.com/HarishNagisetty/origami.el.git" \
...
git clone \
    "https://github.com/HarishNagisetty/vim-colors-solarized.git" \
    ~/.vim/pack/vim-colors-solarized/start/vim-colors-solarized/

git clone \
    "https://github.com/HarishNagisetty/vim-rsi.git" \
    ~/.vim/pack/vim-rsi/start/vim-rsi/

git clone \
    "https://github.com/HarishNagisetty/vim-gnupg.git" \
    ~/.vim/pack/vim-gnupg/start/vim-gnupg/

git clone \
    "https://github.com/HarishNagisetty/verilog_systemverilog.vim.git" \
